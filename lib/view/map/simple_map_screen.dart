...
class _SimpleMapScreenState extends State<SimpleMapScreen> {
  ...
  static const CameraPosition targetPostion = CameraPosition(target: LatLng(37.43296265331129, -122.08832357078792), zoom: 14.0, bearing: 192.0, tilt: 60);
  ...
  Future<void> goToLake() async {
    ...
    controller.animateCamera(CameraUpdate.newCameraPosition(targetPostion));
  }
}